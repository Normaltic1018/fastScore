...
@router.get("/list", response_model=List[team_schema.Team])
...
@router.post("/create", response_model=team_schema.TeamCreate)
...
@router.delete("/delete", response_model=team_schema.TeamDelete)
...
@router.put("/update", response_model=team_schema.TeamUpdate)
