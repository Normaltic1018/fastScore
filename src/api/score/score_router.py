...
@router.post("/addScore/{team_id}", status_code=status.HTTP_204_NO_CONTENT)
...
@router.delete("/delete" , status_code=status.HTTP_202_ACCEPTED, 
               response_model=score_schema.Score)
...
@router.delete("/resetScore", status_code=status.HTTP_204_NO_CONTENT)
